...
function init() {
  ...
  Plotly.newPlot("plot-dot", data, layout);
}
...
function getData() {
  let dataset = d3.csv("https://raw.githubusercontent.com/plotly/datasets/master/2014_apple_stock.csv", function(data){ processData(data) } );
